...
{
    public class ShoppingPendingItemsTabViewModel : BindableBase, INavigationAware
    {
        readonly INavigationService _navigationService;
        readonly Services.IDataService _dataService;

        public ShoppingPendingItemsTabViewModel(INavigationService navigationService, Services.IDataService dataService)
        {
            ...
            PropertyChanged += (s, e) =>
            {
                ...
                {
                    _dataService.MarkIngredientChecked(_clientId, _weekId, SelectedItem.Id);
        ...
        public async void OnNavigatedTo(NavigationParameters parameters)
        {
            ...
            Items.Clear();
            var items = await _dataService.GetShoppingPendingAsync(_weekId, _clientId);
